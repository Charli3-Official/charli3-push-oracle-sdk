from pycardano import (HDWallet, Address, Network, ExtendedSigningKey, PaymentVerificationKey,
                        MultiAsset, ScriptHash, VerificationKeyHash, AssetName)
...
def payment_address_24_base():
    ...
    c3_token_hash = ScriptHash.from_primitive("436941ead56c61dbf9b92b5f566f7d5b9cac08f8c957f28f0bd60d4b")
    ...
    oracle_owner = OracleOwner(network, context, extended_signing_key, spend_vk, node_nft, aggstate_nft
                    , oracle_nft ,minting_nft_hash,c3_token_hash, c3_token_name, oracle_addr, stake_vk)
