...
class TestDeployment(TestBase):
    ...
    async def test_oracle_deploy(self):
        ...
        await start.start_oracle(self.tC3_initial_amount)
        await asyncio.sleep(3)

        # Get Oracle's NFTs (minting policy)
        ...
        self.assert_output(self.oracle_script_address, expected_oracle_feed_output)
